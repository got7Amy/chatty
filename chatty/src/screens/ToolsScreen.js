			...
			<View>
				<View style={styles.menuContainer}>
					...
					>
						...
						<Text style={styles.menuItemText}>今日待办</Text>
					</TouchableOpacity>
				</View>
				...
				<View style={styles.menuContainer}>
					...
					>
						...
						<Text style={styles.menuItemText}>笔记</Text>
					</TouchableOpacity>
					<TouchableOpacity
						style={styles.menuItem}
						onPress={() => navigation.navigate("Year5Calendar")}
					>
				...
				<View style={styles.menuContainer}>
					<TouchableOpacity
						style={styles.menuItem}
						onPress={() => navigation.navigate("Awkward")}
					>
						<Ionicons name="attach-outline" size={40} color="black" />
						<Text style={styles.menuItemText}>尴尬本</Text>
					</TouchableOpacity>
					<TouchableOpacity
						style={styles.menuItem}
					...
					>
						...
						<Text style={styles.menuItemText}>食</Text>
					</TouchableOpacity>
				</View>
			</View>
		</>
