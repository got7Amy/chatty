		...
		<View>
			<View style={styles.menuContainer}>
				...
				>
					...
					<Text style={styles.menuItemText}>计算器</Text>
				</TouchableOpacity>
				<TouchableOpacity
					style={styles.menuItem}
				...
				>
					...
					<Text style={styles.menuItemText}>随机数</Text>
				</TouchableOpacity>
			</View>
			...
			<View style={styles.menuContainer}>
				...
				>
					...
					<Text style={styles.menuItemText}>计数</Text>
				</TouchableOpacity>
			</View>
			...
			<View style={styles.menuContainer}>
				...
				<TouchableOpacity
					style={styles.menuItem}
					onPress={() => navigation.navigate("ROICalculator")}
				>
